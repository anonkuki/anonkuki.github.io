...
- Optimized WebP covers sourced from the corresponding project source trees; every manually reviewed public raster is path- and SHA-256-locked, and no client screenshots or separate copy of the original resume photo exists outside the approved PDF.
...
- `pnpm links:check`: production preview, resume, robots, public demo, and four build-time GitHub snapshot links.
