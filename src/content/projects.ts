...
export const publicProjects: PublicProject[] = [
  ...
  },
  {
    ...
    visibility: 'public',
    title: { zh: '佐佑动漫社 · 星际年度报告', en: 'Zuoyou Anime Club · Galactic Annual Report' },
    description: { zh: '长期设计并迭代的互动年度报告：将社员与运营数据转为专属船票、3D 六星球探索和 17 页个人叙事，贯通数据处理、交互状态机、视觉动效与分享海报。', en: 'A long-running interactive annual report that turns member and operational data into personal tickets, a six-planet 3D journey, and a 17-page story—from data processing and state transitions to motion and shareable posters.' },
    ...publicMetadata('Zuoyou-Anime-Club-2025-Annual-Summary', { language: 'JavaScript', demoUrl: 'https://anonkuki.github.io/Zuoyou-Anime-Club-2025-Annual-Summary/' }),
    tags: ['Three.js', 'GSAP', 'Data Visualization', 'Interactive Story'],
    covers: [{ src: '/project-covers/club-space.webp', label: { zh: '年度星际报告', en: 'Annual space report' } }],
    links: [{ repo: 'Zuoyou-Anime-Club-2025-Annual-Summary', label: { zh: '年度星际报告', en: 'Annual report' }, url: 'https://github.com/anonkuki/Zuoyou-Anime-Club-2025-Annual-Summary', demoUrl: 'https://anonkuki.github.io/Zuoyou-Anime-Club-2025-Annual-Summary/' }],
  },
  {
    repo: 'zuoyou_web',
    repositories: ['zuoyou_web'],
    visibility: 'public',
    title: { zh: '佐佑动漫社 · 冒险者公会', en: 'Zuoyou Anime Club · Adventurer Guild' },
    description: { zh: '面向真实社团运营长期开发的全栈系统：以像素 RPG 公会包装招新、成员、活动、作品、任务、文件与沟通闭环，并落实共享契约、分级权限、审计日志和生产部署。', en: 'A long-running full-stack system for real club operations. A pixel-RPG guild wraps recruitment, members, events, works, tasks, files, and communication, backed by shared contracts, scoped permissions, audit logs, and production deployment.' },
    ...publicMetadata('zuoyou_web', { language: 'TypeScript', demoUrl: 'http://62.234.83.174:8080/' }),
    tags: ['React', 'Fastify', 'TypeScript', 'SQLite'],
    covers: [{ src: '/project-covers/club-guild.webp', label: { zh: '冒险者公会', en: 'Adventurer guild' } }],
    links: [{ repo: 'zuoyou_web', label: { zh: '冒险者公会', en: 'Adventurer guild' }, url: 'https://github.com/anonkuki/zuoyou_web', demoUrl: 'http://62.234.83.174:8080/' }],
  },
  {
    ...
    description: { zh: '源自满文古籍识别与修复项目：构建文本感知退化、合成样本与数据增强流水线，并参与训练数据设计、模型训练实验和效果迭代，支撑低质量古籍 OCR。', en: 'From a Manchu recognition and restoration project: built text-aware degradation, synthetic-sample, and augmentation pipelines, and worked on training-data design, model-training experiments, and iterative evaluation for low-quality historical OCR.' },
    highlight: { zh: '北京市大学生创新创业大赛市级奖项', en: 'Beijing Municipal Award · College Student Innovation & Entrepreneurship Competition' },
    ...publicMetadata('manchu-degradation-simulator', { language: 'Python' }),
    tags: ['Python', 'OCR', 'Model Training', 'Data Augmentation'],
