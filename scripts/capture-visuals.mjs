...
for (const profile of profiles) {
  ...
  if (profile.name === 'desktop-1440x900') {
    ...
    await page.addStyleTag({ content: '.open-section,.atlas-section,.experience-section,.skills-section,.contact-section{content-visibility:visible!important}' })
    await page.screenshot({ path: path.join(output, 'desktop-full-page.png'), fullPage: true })
    await page.addStyleTag({ content: '.site-header,.skip-link{display:none!important}.reveal{opacity:1!important;transform:none!important}' })
